...
----
curl -s -X POST \
"http://localhost:8090/auth/admin/realms/trikorasolutions/roles" \
-H "Content-Type: application/json" \
-H "Authorization: Bearer ${TKN}" \
-d '{"name": "test-role2","description": "test-role2"}' | jq .
...
----
curl -s -X DELETE \
"http://localhost:8090/auth/admin/realms/trikorasolutions/roles-by-id/21717352-777b-4865-bad1-5400e7c25923" \
-H "Content-Type: application/json" \
-H "Authorization: Bearer ${TKN}" | jq .
